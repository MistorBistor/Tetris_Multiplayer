...
void Board::render (sf::RenderWindow& window) {
    ...
    auto getColorForType = [this](TetrominoType type) -> sf::Color {
        switch (type) {
        case TetrominoType::I: return currentTheme.I;
        case TetrominoType::O: return currentTheme.O;
        case TetrominoType::T: return currentTheme.T;
        case TetrominoType::S: return currentTheme.S;
        case TetrominoType::Z: return currentTheme.Z;
        case TetrominoType::J: return currentTheme.J;
        case TetrominoType::L: return currentTheme.L;
        ...
        for (int col = 0; col < COLS; col++) {
            ...
            if (rowClearing) {
                if (blinkOn) {
                    ...
                    cell.setFillColor (currentTheme.highlight);   // możesz zmienić na White
...
void Board::setTheme (const ColorTheme& theme) {
    currentTheme = theme;
}
